...
int Timer1APriority =  (0x00000000);  //setting the priority to 0 (bits 13-15) 
int Timer2APriority = 0x20000000; //setting the priority to 1 // (bits 29 -31)
int UART0Priority = 0x00006000; //setting the UART priotiy to 3 (bits 13 - 15)
int PendSVPriority = 0x00E00000; //setting the PendSV priotiy to 7 (bits 21 - 23)
int SysTickPriority =  0x40000000; //setting the SysTick priority to 2 (bits 29-31
